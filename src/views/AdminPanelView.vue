...
onMounted(async () => {
  ...
  const apiRequests = [otherUsersStore.getRegisterRequests(), isOwner.value ? otherUsersStore.getOtherUsers() : Promise.resolve(null)]
...
<template>
  ...
  <div class="main-container" v-if="otherUsersStore.requestsLoading && (isOwner ? otherUsersStore.otherUsersLoading : true)">
