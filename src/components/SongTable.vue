...
<template>
  <div id="song-table">
    <div class="song-item" v-for="(song, index) of songs" :class="{ 'enabled-select': enableSelect, 'checked': checkedSongs?.includes(song.songId) }" @click="handleToggleSong(song.songId)">
